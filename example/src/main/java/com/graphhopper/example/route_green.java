...
public class route_green {
    ...
    public static void main(String[] args) throws CsvValidationException, IOException {
        ...
        String filePath =prefix+"_" +"route22.txt";
        String filePath2 = prefix+"_"+"time22.txt";
        String filePath3 = prefix+"_"+"time222.txt";
        ...
        while (nextLine != null)//&& i<1423)//87)//2487)//)487)
        {
            i += 1;
            double lat1 = Double.parseDouble(nextLine[3]);
            double lon1 = Double.parseDouble(nextLine[2]);
            double lat2 = Double.parseDouble(nextLine[5]);
            double lon2 = Double.parseDouble(nextLine[4]);
            retult = routing(hopper, lat1, lon1, lat2, lon2, outputStream);
            //nextLine = reader.readNext();
            ...
            if (retult==1)
            {
                ...
                byte[] binaryData2 = nextLine[6].getBytes();
    ...
    public static int routing(GraphHopper hopper,double lat1,double lon1,double lat2,double lon2,BufferedOutputStream  outputStream )  {
